...
```{r}
edges = melt(A) %>% rename(Source = Var1, Target = Var2, Weight = value)%>%mutate(Type = "Undirected") %>% select(Source, Target, Type, Weight) %>% 
filter(Weight != 0)
...
$$\text{Figure 4.1: Top 12 nodes with the highest degree, eigenvector centrality, closeness centrality and betweenness centrality}$$

## Preliminary Conclusions

Here comes the questionL