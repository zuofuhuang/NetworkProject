...
Our initial thought was that Genome-Wide Association Studies (GWAS) data is widely available

## Simulate original data

We start by creating the dataset. Everyone row is set to the reference level first (i.e. there is no variant).
...
With the mutations that non-patients had at SNP locations, some of them may fall into the "disease" status. We then performed a round of screening for 400 people who were initially categorized without the disease. Surprisingly, we found that a large number of people fall into the "disease" status. We were surprised for two reasons:
