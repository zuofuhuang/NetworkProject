...
Suppose we have a disease. It is reasonable to assume that we know where the mutations related to this disease approximately are along the genome. As shown below, we guess that 1000 loci (specific position where a gene is located) could harbor the disease-related mutations. We assumed that each locus contains 200 base pairs (a pair of complementary bases in a double-stranded DNA: A-T, G-C).
